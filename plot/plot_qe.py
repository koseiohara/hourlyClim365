...
def qe_mkgrph(figname, title, timestep, dataset, ini, fin, flag):
    ...
    total_file = set_input_file(dataset, ini, fin, 'VINT',       'qe', flag, 'grd')
    ttswr_file = set_input_file(dataset, ini, fin, 'VINT', 'ttswr_qe', flag, 'grd')
    ttlwr_file = set_input_file(dataset, ini, fin, 'VINT', 'ttlwr_qe', flag, 'grd')
    lrghr_file = set_input_file(dataset, ini, fin, 'VINT', 'lrghr_qe', flag, 'grd')
    cnvhr_file = set_input_file(dataset, ini, fin, 'VINT', 'cnvhr_qe', flag, 'grd')
    vdfhr_file = set_input_file(dataset, ini, fin, 'VINT', 'vdfhr_qe', flag, 'grd')
