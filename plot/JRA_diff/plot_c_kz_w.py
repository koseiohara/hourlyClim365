...
def c_kz_w_mkgrph(ini, fin, data1, data2, flag1, flag2):

    var = 'c_kz_w'
    var_tex = r'$C\left(K_Z, W\right)$'

    ifile1_ae = set_input_file(data1, ini, fin, 'VINT', 'c_kz_ae', flag1, 'grd')
    ifile2_ae = set_input_file(data2, ini, fin, 'VINT', 'c_kz_ae', flag2, 'grd')
    ifile1_ke = set_input_file(data1, ini, fin, 'VINT', 'c_kz_ke', flag1, 'grd')
    ifile2_ke = set_input_file(data2, ini, fin, 'VINT', 'c_kz_ke', flag2, 'grd')
    ...
    DJFline, MAMline, JJAline, SONline = c_kz_w_ax(ax, DJF, MAM, JJA, SON, title, 1, 5.)
