...
def c_kz_ae_mkgrph(ini, fin, data1, data2, flag1, flag2):

    var = 'c_kz_ae'
    var_tex = r'$C\left(K_Z, A_E\right)$'
    ...
    DJFline, MAMline, JJAline, SONline = c_kz_ae_ax(ax, DJF, MAM, JJA, SON, title, 1, 5.)
