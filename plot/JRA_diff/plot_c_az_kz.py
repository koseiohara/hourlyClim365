...
def c_az_kz_mkgrph(ini, fin, data1, data2, flag1, flag2):

    var = 'c_az_kz'
    var_tex = r'$C\left(A_Z, K_Z\right)$'
    ...
    DJFline, MAMline, JJAline, SONline = c_az_kz_ax(ax, DJF, MAM, JJA, SON, title, 1, 5.)
