...
def c_kz_ke_mkgrph(ini, fin, data1, data2, flag1, flag2):

    var = 'c_kz_ke'
    var_tex = r'$C\left(K_Z, K_E\right)$'
    ...
    DJFline, MAMline, JJAline, SONline = c_kz_ke_ax(ax, DJF, MAM, JJA, SON, title, 1, 5.)
