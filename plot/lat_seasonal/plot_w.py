...
def w_mkgrph(figname, title, dataset, ini, fin, flag):

    ifileae = set_input_file(dataset, ini, fin, 'VINT', 'ae', flag, 'grd')
    ifileke = set_input_file(dataset, ini, fin, 'VINT', 'ke', flag, 'grd')
    ...
    DJFline, MAMline, JJAline, SONline = w_ax(ax, DJF, MAM, JJA, SON, title, 1, 1.)
